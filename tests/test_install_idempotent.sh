...
assert_count "$TEMP_DIR/.claude/agents" "*.md" "16" "Agent count correct after 2nd install"
assert_count "$TEMP_DIR/.claude/commands" "*.md" "31" "Command count correct after 2nd install"
